...
<h3 align="center">Социальный университет с открытым исходным кодом</h3>
<p align="center">
...
Это не только для карьерного обучения или профессионального развития.
Это для тех, кто хочет получить надлежащее, *всестороннее* представление о концепциях, лежащих в основе всех компьютерных дисциплин.
а для тех, кто имеет дисциплину, волю и (главное!) хорошие привычки получать это образование во многом самостоятельно,
но при поддержке мирового сообщества однокурсников.

Он разработан в соответствии с требованиями к степени бакалавра по информатике за вычетом требований общего образования (не CS),
поскольку предполагается, что большинство людей, изучающих эту учебную программу, уже получили образование за пределами области компьютерных наук.
Сами курсы являются одними из лучших в мире, часто из Гарварда, Принстона, Массачусетского технологического института и т. д.
но специально выбраны для удовлетворения следующих критериев.

**Курсы должны**:
- Быть открытым для записи
- Запускайте регулярно (в идеале в формате самостоятельного темпа, в противном случае запускайте несколько раз в год)
...
Когда ни один курс не соответствует вышеуказанным критериям, курсовая работа дополняется книгой.
Когда есть курсы или книги, которые не вписываются в учебную программу, но в остальном имеют высокое качество,
они относятся к [дополнениям/курсам](extras/courses.md) или [дополнениям/чтениям](extras/readings.md).

**Организация**. Учебная программа разработана следующим образом:
- *Введение в CS*: для студентов, которые могут попробовать CS и посмотреть, подходит ли это им
- *Core CS*: примерно соответствует первым трем годам учебной программы по информатике, включая курсы, которые должны пройти все специалисты.
- *Advanced CS*: примерно соответствует последнему году учебной программы по информатике, факультативы выбираются в соответствии с интересами учащегося.
...
**Продолжительность**. Можно закончить примерно через 2 года, если вы тщательно спланируете и посвящаете учебе около 20 часов в неделю. Учащиеся могут использовать [данный разворот
...
Решите, сколько или как мало потратить, исходя из собственного времени и бюджета;
просто помните, что вы не можете купить успех!

**Процесс**. Студенты могут работать с учебным планом в одиночку или в группах, по порядку или не по порядку.
- Мы рекомендуем проходить все курсы в Core CS, пропуская курс только в том случае, если вы уверены, что уже изучили материал ранее.
- Для простоты мы рекомендуем проходить курсы (особенно Core CS) в порядке сверху вниз, так как они уже были [топологически отсортированы](https://en.wikipedia.org/wiki/Topological_sorting) по их предварительным требованиям.
...
**Политика в отношении содержания**. Если вы планируете публиковать некоторые из своих курсовых работ, вы должны делиться только теми файлами, к которым у вас есть доступ.
*НЕ пренебрегайте кодексом поведения*, который вы подписали в начале каждого курса!
...
- Добавьте **Университет открытого исходного кода** в свой профиль [Linkedin](https://www.linkedin.com/school/11272443/)!
...
- [Предпосылки](#предварительные требования)
- [Введение CS](#intro-CS)
   - [Введение в программирование](#introduction-to-programming)
   - [Введение в информатику](#introduction-to-computer-science)
- [Основной CS](#core-CS)
   - [Основное программирование](#core-programming)
   - [Основная математика](#core-math)
   - [Инструменты CS](#cs-tools)
   - [Основные системы](#ядерные-системы)
   - [Основная теория](#core-theory)
   - [Основная безопасность](#core-security)
   - [Основные приложения](#core-applications)
   - [Основная этика](#core-ethics)
- [Продвинутый CS](#advanced-CS)
   - [Расширенное программирование](#advanced-programming)
   - [Расширенные системы](#расширенные-системы)
   - [Расширенная теория](#advanced-theory)
   - [Продвинутая математика](#продвинутая-математика)
- [Окончательный проект](#final-project)
...
Если вы никогда не писали цикл for или не знаете, что такое строка в программировании, начните здесь. Этот курс предназначен для самостоятельного изучения, что позволяет вам регулировать количество часов, которые вы тратите в неделю, в соответствии со своими потребностями.
...
Этот курс познакомит вас с миром информатики. Студенты, которые познакомились с программированием либо на курсах, описанных выше, либо в других местах, должны пройти этот курс, чтобы получить представление о будущем материале. Если вы закончите курс, желая большего, компьютерные науки, скорее всего, для вас!
...
Все курсовые работы в рамках Core CS **обязательны**, если не указано иное.
...
`Языки семейства ML (через стандартный ML)`
`Языки семейства Lisp (через Racket)`
`Рубин`
`и многое другое`

Курсы «Как кодировать» основаны на учебнике «Как разрабатывать программы» (https://htdp.org/2003-09-26/). Первое издание доступно бесплатно в Интернете и включает в себя наборы задач и решения. Учащимся предлагается выполнить эти задания.
...
[Объектно-ориентированный дизайн] (https://www.coursera.org/learn/object-Oriented-design) | 4 недели | 4 часа в неделю | [Базовая Java](https://www.youtube.com/watch?v=GoXwIVyNvX0)
...
### Основная математика
Дискретная математика (Math for CS) является обязательным условием и тесно связана с изучением алгоритмов и структур данных. Исчисление готовит учащихся к дискретной математике и помогает учащимся развить математическую зрелость.
...
Курсы | Продолжительность | усилие | Дополнительный текст/задания| Предпосылки | Обсуждение
:-- | :--: | :--: | :--: | :--: | :--:
...
1. Скопируйте [эту](https://trello.com/b/IScNSzsI/ossu-compsci) доску в свой личный кабинет.
